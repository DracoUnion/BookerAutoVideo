...
def main():
    ...
    video2txt_parser.add_argument("-p", "--ppt-thres", type=float, default=0.5, help="img ppt thres")
    ...
    kf_parser.add_argument("-p", "--ppt-thres", type=float, default=0.5, help="img ppt thres")
